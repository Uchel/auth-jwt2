...
type AuthExampleAdminLoginController struct {
	exampleAdminUsecase usecase.ExampleAdminLoginUsecase
}

func (c *AuthExampleAdminLoginController) LoginExampleAdmin(ctx *gin.Context) {
	...
	email, password := c.exampleAdminUsecase.FindByEmailExampleAdmin(loginReq.Email)
...
func NewExampleAdminLoginController(u usecase.AdminWhLoginUsecase) *AuthAdminWhLoginController {
